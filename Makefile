...
CFLAGS := -Wall -Wextra -D__3DS__ -O3 -g3 \
    $(ARCH) \
    $(foreach d,$(INCLUDES),-I$(TOPDIR)/$(d)) \
    -I$(DEVKITPRO)/libctru/include \
    -I$(DEVKITPRO)/portlibs/3ds/include \
    -I$(DEVKITPRO)/portlibs/3ds/include/sidplay \
...
# Add libraries
LIBS := -lsidplay -lctru -lm -lmpg123 -lcitro2d -lcitro3d -lctru -lm
